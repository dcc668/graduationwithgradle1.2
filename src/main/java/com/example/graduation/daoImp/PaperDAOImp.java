...
@Repository
public class PaperDAOImp extends IDAOImpl<Paper> implements PaperDAO {

    @Override
    public List<Paper> getPapersByTeId(Integer teId) {
        Session session=sessionFactory.getCurrentSession();
        StringBuffer sql=new StringBuffer("from Paper where teId= ?");
    ...
    public List<Paper> getPapersByIds(Serializable... ids) {
            Session session=sessionFactory.getCurrentSession();
            StringBuffer sql=new StringBuffer("from Paper where paId in (:ids)");
