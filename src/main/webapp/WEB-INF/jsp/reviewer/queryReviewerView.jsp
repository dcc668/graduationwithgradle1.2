...
<script type="text/javascript">
	function del(id){
		...
		$("#deleteForm").attr("action","main/reviewer/deleteReviewer/"+id+"");
	...
	<form id="deleteForm"action="" method="get">
  			...
  			<tr>
		        ...
		        <c:forEach items="${teaInfs}" var="titleReviewInfo">
		       	 	<tr>
							<td><span>${titleReviewInfo.revId }</span></td>
							<td><span>${titleReviewInfo.revName }</span></td>
							<td><a href="<c:url value='main/reviewer/updateReviewerView/${titleReviewInfo.revId}'/>">更新</a></td> 
...
<%-- 							<td ><a href="javascript:del1('${titleReviewInfo.tId }')">更新</a></td>--%>
							<td ><a  href="javascript:del('${titleReviewInfo.revId}')">删除</a></td> 
					</tr>
				</c:forEach>
