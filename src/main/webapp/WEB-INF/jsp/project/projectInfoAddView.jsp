...
<head lang="en">
    <meta charset="UTF-8">
    <title>--</title>
    <link rel="stylesheet" href="${basePath}/WEB-INF/jsp/project/style_project.css">
...
<script type="text/javascript" src="${basePath}/WEB-INF/jsp/project/project_ajax.js"></script>
