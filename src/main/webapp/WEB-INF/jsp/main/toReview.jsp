...
<html>
  ...
  <body>
  			<table border="1" bordercolor="#E0E4CC">
  			<tr>
  				<th>ID</th>
  				<th>题目ID</th>
  				<th>题目名称</th>
		        ...
		        <c:forEach items="${triList}" var="titleReviewInfo">
						...
						<%-- 	<td><a href="main/permitPass/${titleReviewInfo.titleId }">准许通过</a></td> --%>
							<td><a href="<c:url value='main/permitPass/${titleReviewInfo.titleId }'/>">准许通过</a></td>
							<td ><a href="<c:url value='main/permitFail/${titleReviewInfo.titleId }'/>">通不过</a></td>
					</tr>
				</c:forEach>
			</table>
  </body>
